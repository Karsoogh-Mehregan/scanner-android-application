...
export default function Login({ navigation }) {
    ...
    const goToNextPage = () => {
        setIsLoading(true)
        axios.post("https://karsoogh.at1d.ir/users/login", {
                ...
                <Text style={{"fontSize":20, "fontFamily":"Vazir-Bold"}}>اول باید لاگین کنی!</Text>
                    <View style={{"gap":10, "width":"100%", "alignItems":"center"}}>
                        <View style={styles.InputGroup}>
                            ...
                            <CustomTextInput onChangeText={newText => setUserNameState(newText)} font="Vazir-Regular" textContentType="username" selectionColor="gray"  placeholder="Example: At1X"></CustomTextInput>
                        </View>
                        <View style={[styles.InputGroup, {"marginTop":5}]}>
                            <CustomText font="Vazir-Bold">رمز عبور:</CustomText>
                            <CustomTextInput onChangeText={newText => setPasswordState(newText)} font="Vazir-Regular" secureTextEntry={true} textContentType="password" selectionColor="gray" placeholder="Example: A*&jQ@B"></CustomTextInput>
                        </View>
